...
cycle.addEventListener('click', function() {
  ...
  for (var prob = 0; prob <= 1; prob += 0.01) {
    ...
    console.log('Calc No. ' + prob + ' done.');
  }
  var convert = 512 / times;

  context2.moveTo(0, 0);
  context2.lineTo(1, 6);
  context2.moveTo(2, 2);
  context2.lineTo(15, 2);
  context2.strokeStyle = 'black';
  context2.stroke();
  for (var i = 1; i < count.length; i++) {
    context2.moveTo((i - 1) * convert, (count[i - 1]) * convert) + 1;
    context2.lineTo(i * convert, count[i] * convert) + 1;
  }
  context2.strokeStyle = 'black';
  context2.stroke();
